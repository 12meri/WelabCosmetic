...
@Component({
  ...
  templateUrl: './demande-echantillon-list.component.html',
  styleUrl: './demande-echantillon-list.component.css',
})
export class DemandeEchantillonList implements OnInit {
  /** Liste des demandes d'échantillon. */
  ...
  goToEmail(demandeId: number): void {
  this.router.navigate(['/emails/add'], { queryParams: { demandeId: demandeId } });
}
  loadDemandes(): void {
