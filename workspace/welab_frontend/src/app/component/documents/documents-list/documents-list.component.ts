...
export class DocumentsList implements OnInit {
  /** 
   * Ce composant est responsable de l'affichage de la liste des documents, ainsi que de la gestion de leur chargement et de leur affichage dans le template.
   */
